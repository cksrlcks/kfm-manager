...
import { QuotationPreview, QuotationPreviewDialog } from "./Preview";
...
export default function QuotationForm({
  ...
  return (
    <div
      className={cn(
        isSplitMode &&
          "fixed top-0 left-0 z-40 flex h-full w-full gap-10 overflow-hidden bg-white pl-[40%]",
      )}
      data-split-mode={isSplitMode}
    >
      {isSplitMode && (
        <div className="bg-accent-foreground absolute top-0 left-0 h-full w-[40%] overflow-y-scroll p-6">
      ...
      <div
        className={cn("flex-1", isSplitMode && "h-full overflow-y-scroll p-10")}
      >
        <Form {...form}>
          <form onSubmit={handleSubmit}>
            <div className="mb-4 flex w-full items-center justify-between">
              ...
              <div className="flex gap-1">
                ...
                {mode === "normal" && (
                  <QuotationPreviewDialog data={previewData}>
